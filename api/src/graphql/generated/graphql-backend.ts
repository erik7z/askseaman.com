...
> = ResolversObject<{
	...
	owner?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<QuestionOwnerArgs, never>
	>
	...
	tagged?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<QuestionTaggedArgs, never>
	>
	createdAt?: Resolver<
		Maybe<ResolversTypes['_Neo4jDateTime']>,
		ParentType,
...
> = ResolversObject<{
	...
	owner?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<AnswerOwnerArgs, never>
	>
	comments?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['Comment']>>>,
		ParentType,
...
> = ResolversObject<{
	...
	owner?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<CommentOwnerArgs, never>
	>
	answer?: Resolver<
		ResolversTypes['Answer'],
		ParentType,
		ContextType,
		RequireFields<CommentAnswerArgs, never>
	>
	text?: Resolver<ResolversTypes['String'], ParentType, ContextType>
	createdAt?: Resolver<
		Maybe<ResolversTypes['_Neo4jDateTime']>,
...
export type LikedResolvers<
	ContextType = any,
	ParentType extends ResolversParentTypes['Liked'] = ResolversParentTypes['Liked']
> = ResolversObject<{
...
> = ResolversObject<{
	...
	ForgotPass?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationForgotPassArgs, 'data'>
	>
	...
	>
	AddQuestionTag?: Resolver<
		ResolversTypes['Question'],
		ParentType,
		ContextType,
		RequireFields<MutationAddQuestionTagArgs, 'data'>
	>
	...
	>
	CommentQuestion?: Resolver<
		ResolversTypes['Comment'],
		ParentType,
		ContextType,
		RequireFields<MutationCommentQuestionArgs, 'data'>
	>
	CommentAnswer?: Resolver<
		ResolversTypes['Comment'],
		ParentType,
		ContextType,
		RequireFields<MutationCommentAnswerArgs, 'data'>
	>
	...
	EditTag?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationEditTagArgs, 'data'>
	>
	DeleteTag?: Resolver<
		ResolversTypes['Tag'],
		ParentType,
	...
	>
	LikeCommentOrQuestion?: Resolver<
		ResolversTypes['Comment'],
		ParentType,
		ContextType,
		RequireFields<MutationLikeCommentOrQuestionArgs, 'data'>
	>
	SubscribeQuestion?: Resolver<
		ResolversTypes['Question'],
		ParentType,
		ContextType,
		RequireFields<MutationSubscribeQuestionArgs, 'data'>
	>
}>
