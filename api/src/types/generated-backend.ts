...
> = ResolversObject<{
	...
	>
	AskQuestionResponse?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['AskQuestionResponse']>>>,
		ParentType,
		ContextType,
		RequireFields<QueryAskQuestionResponseArgs, never>
	>
	AnswerQuestionResponse?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['AnswerQuestionResponse']>>>,
		ParentType,
		ContextType,
		RequireFields<QueryAnswerQuestionResponseArgs, never>
	>
	AddCommentResponse?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['AddCommentResponse']>>>,
		ParentType,
		ContextType,
		RequireFields<QueryAddCommentResponseArgs, never>
	>
}>
