...
export type ToggleLikeMutation = (
  ...
  & { ToggleLike: (
    { __typename: 'Question' }
    & Pick<Question, 'likesCount' | 'isLiked' | 'canLike'>
  ) | (
    { __typename: 'Comment' }
    & Pick<Comment, 'likesCount' | 'isLiked' | 'canLike'>
  ) }
);
...
export type ToggleSubscribeMutation = (
  { __typename?: 'Mutation' }
  & { ToggleSubscribe: (
    { __typename: 'Question' }
    & Pick<Question, 'nodeId' | 'subscribersCount' | 'isSubscribed'>
  ) | (
    { __typename: 'Tag' }
    & Pick<Tag, 'nodeId' | 'subscribersCount' | 'isSubscribed'>
  ) }
);

export type TagsCloudQueryVariables = Exact<{
  orderBy?: Maybe<Array<Maybe<_TagOrdering>> | Maybe<_TagOrdering>>;
  first?: Maybe<Scalars['Int']>;
}>;


export type TagsCloudQuery = (
  { __typename?: 'Query' }
...
export type UserFieldsFragment = (
  { __typename?: 'User' }
  & Pick<User, 'nodeId' | 'name' | 'surname' | 'avatar' | 'rank' | 'description'>
);

export type TagFieldsFragment = (
  { __typename?: 'Tag' }
  & Pick<Tag, 'nodeId' | 'name' | 'questionsCount' | 'subscribersCount' | 'canSubscribe' | 'isSubscribed'>
);

export type QuestionListItemFieldsFragment = (
  { __typename?: 'Question' }
  & Pick<Question, 'nodeId' | 'title' | 'text' | 'viewsCount' | 'answersCount' | 'commentsCount' | 'canSubscribe' | 'isSubscribed' | 'subscribersCount'>
  & { author?: Maybe<(
    { __typename?: 'User' }
    & UserFieldsFragment
  )>, createdAt?: Maybe<(
...
export type CommentFieldsFragment = (
  { __typename?: 'Comment' }
  & Pick<Comment, 'nodeId' | 'text' | 'likesCount' | 'isLiked' | 'canLike'>
  & { createdAt?: Maybe<(
    { __typename?: '_Neo4jDateTime' }
    & DateTimeFieldsFragment
  )>, author?: Maybe<(
...
export type AnswerFieldsFragment = (
  { __typename?: 'Answer' }
  & Pick<Answer, 'nodeId' | 'text' | 'canVote' | 'upVotesCount' | 'downVotesCount' | 'isVotedUp' | 'isVotedDown' | 'canComment' | 'commentsCount'>
  & { author: (
    { __typename?: 'User' }
    & UserFieldsFragment
  ), createdAt?: Maybe<(
...
export type FormErrorFieldsFragment = (
  { __typename?: 'FormError' }
...
export type EditProfileMutation = (
  ...
  & { EditProfile: (
    { __typename: 'Profile' }
    & Pick<Profile, 'name' | 'surname' | 'avatar' | 'rank' | 'description' | 'isPasswordChanged'>
  ) | (
    { __typename: 'FormError' }
    & FormErrorFieldsFragment
  ) }
...
export type QuestionAnswersListQuery = (
  { __typename?: 'Query' }
  & { Answer?: Maybe<Array<Maybe<(
    { __typename?: 'Answer' }
    & AnswerFieldsFragment
...
export type QuestionPageQuery = (
  ...
  & { Question?: Maybe<Array<Maybe<(
    { __typename?: 'Question' }
    & Pick<Question, 'nodeId' | 'title' | 'text' | 'viewsCount' | 'answersCount' | 'canSubscribe' | 'isSubscribed' | 'subscribersCount' | 'canComment' | 'commentsCount'>
    & { author?: Maybe<(
      { __typename?: 'User' }
      & UserFieldsFragment
    )>, tags?: Maybe<Array<Maybe<(
...
export type VoteMutation = (
  ...
  & { Vote: (
    { __typename: 'Question' }
    & Pick<Question, 'nodeId' | 'upVotesCount' | 'downVotesCount' | 'canVote' | 'isVotedUp' | 'isVotedDown'>
  ) | (
    { __typename: 'Answer' }
    & Pick<Answer, 'nodeId' | 'upVotesCount' | 'downVotesCount' | 'canVote' | 'isVotedUp' | 'isVotedDown'>
  ) }
);
...
export type TagPageQuery = (
  ...
  & { Tag?: Maybe<Array<Maybe<(
    { __typename?: 'Tag' }
    & Pick<Tag, 'description' | 'questionsSolvedCount'>
...
export type UserPageQuery = (
  ...
  & { User?: Maybe<Array<Maybe<(
    { __typename?: 'User' }
    & Pick<User, 'email' | 'location' | 'questionsCount' | 'answersCount' | 'questionsSolvedCount'>
    & { favoriteTags?: Maybe<Array<Maybe<(
      { __typename?: 'Tag' }
      & TagFieldsFragment
...
export const ToggleSubscribeDocument = gql`
  ...
  ToggleSubscribe(data: $data) {
    ...
    `;
export type ToggleSubscribeMutationFn = Apollo.MutationFunction<ToggleSubscribeMutation, ToggleSubscribeMutationVariables>;
 ...
 * });
 */
export function useToggleSubscribeMutation(baseOptions?: Apollo.MutationHookOptions<ToggleSubscribeMutation, ToggleSubscribeMutationVariables>) {
        return Apollo.useMutation<ToggleSubscribeMutation, ToggleSubscribeMutationVariables>(ToggleSubscribeDocument, baseOptions);
      }
export type ToggleSubscribeMutationHookResult = ReturnType<typeof useToggleSubscribeMutation>;
export type ToggleSubscribeMutationResult = Apollo.MutationResult<ToggleSubscribeMutation>;
export type ToggleSubscribeMutationOptions = Apollo.BaseMutationOptions<ToggleSubscribeMutation, ToggleSubscribeMutationVariables>;
export const TagsCloudDocument = gql`
    query TagsCloud($orderBy: [_TagOrdering], $first: Int = 10) {
  Tag(orderBy: $orderBy, first: $first) {
    nodeId
    name
  }
}
...
/**
 * __useTagsCloudQuery__
 *
 * To run a query within a React component, call `useTagsCloudQuery` and pass it any options that fit your needs.
 * When your component renders, `useTagsCloudQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTagsCloudQuery({
 *   variables: {
 ...
 * });
 */
export function useTagsCloudQuery(baseOptions?: Apollo.QueryHookOptions<TagsCloudQuery, TagsCloudQueryVariables>) {
        return Apollo.useQuery<TagsCloudQuery, TagsCloudQueryVariables>(TagsCloudDocument, baseOptions);
      }
export function useTagsCloudLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TagsCloudQuery, TagsCloudQueryVariables>) {
          return Apollo.useLazyQuery<TagsCloudQuery, TagsCloudQueryVariables>(TagsCloudDocument, baseOptions);
        }
export type TagsCloudQueryHookResult = ReturnType<typeof useTagsCloudQuery>;
export type TagsCloudLazyQueryHookResult = ReturnType<typeof useTagsCloudLazyQuery>;
export type TagsCloudQueryResult = Apollo.QueryResult<TagsCloudQuery, TagsCloudQueryVariables>;
 ...
 * });
 */
export function useAnswerCommentsQuery(baseOptions: Apollo.QueryHookOptions<AnswerCommentsQuery, AnswerCommentsQueryVariables>) {
        return Apollo.useQuery<AnswerCommentsQuery, AnswerCommentsQueryVariables>(AnswerCommentsDocument, baseOptions);
      }
export function useAnswerCommentsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AnswerCommentsQuery, AnswerCommentsQueryVariables>) {
          return Apollo.useLazyQuery<AnswerCommentsQuery, AnswerCommentsQueryVariables>(AnswerCommentsDocument, baseOptions);
        }
export type AnswerCommentsQueryHookResult = ReturnType<typeof useAnswerCommentsQuery>;
export type AnswerCommentsLazyQueryHookResult = ReturnType<typeof useAnswerCommentsLazyQuery>;
export type AnswerCommentsQueryResult = Apollo.QueryResult<AnswerCommentsQuery, AnswerCommentsQueryVariables>;
...
export function useAnswerQuestionMutation(baseOptions?: Apollo.MutationHookOptions<AnswerQuestionMutation, AnswerQuestionMutationVariables>) {
        return Apollo.useMutation<AnswerQuestionMutation, AnswerQuestionMutationVariables>(AnswerQuestionDocument, baseOptions);
      }
 ...
 * });
 */
export function useQuestionAnswersListQuery(baseOptions?: Apollo.QueryHookOptions<QuestionAnswersListQuery, QuestionAnswersListQueryVariables>) {
        return Apollo.useQuery<QuestionAnswersListQuery, QuestionAnswersListQueryVariables>(QuestionAnswersListDocument, baseOptions);
      }
export function useQuestionAnswersListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<QuestionAnswersListQuery, QuestionAnswersListQueryVariables>) {
          return Apollo.useLazyQuery<QuestionAnswersListQuery, QuestionAnswersListQueryVariables>(QuestionAnswersListDocument, baseOptions);
        }
export type QuestionAnswersListQueryHookResult = ReturnType<typeof useQuestionAnswersListQuery>;
export type QuestionAnswersListLazyQueryHookResult = ReturnType<typeof useQuestionAnswersListLazyQuery>;
export type QuestionAnswersListQueryResult = Apollo.QueryResult<QuestionAnswersListQuery, QuestionAnswersListQueryVariables>;
 ...
 * });
 */
export function useQuestionCommentsQuery(baseOptions: Apollo.QueryHookOptions<QuestionCommentsQuery, QuestionCommentsQueryVariables>) {
        return Apollo.useQuery<QuestionCommentsQuery, QuestionCommentsQueryVariables>(QuestionCommentsDocument, baseOptions);
      }
export function useQuestionCommentsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<QuestionCommentsQuery, QuestionCommentsQueryVariables>) {
          return Apollo.useLazyQuery<QuestionCommentsQuery, QuestionCommentsQueryVariables>(QuestionCommentsDocument, baseOptions);
        }
export type QuestionCommentsQueryHookResult = ReturnType<typeof useQuestionCommentsQuery>;
export type QuestionCommentsLazyQueryHookResult = ReturnType<typeof useQuestionCommentsLazyQuery>;
export type QuestionCommentsQueryResult = Apollo.QueryResult<QuestionCommentsQuery, QuestionCommentsQueryVariables>;
 ...
 * });
 */
export function useQuestionPageQuery(baseOptions: Apollo.QueryHookOptions<QuestionPageQuery, QuestionPageQueryVariables>) {
        return Apollo.useQuery<QuestionPageQuery, QuestionPageQueryVariables>(QuestionPageDocument, baseOptions);
      }
export function useQuestionPageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<QuestionPageQuery, QuestionPageQueryVariables>) {
          return Apollo.useLazyQuery<QuestionPageQuery, QuestionPageQueryVariables>(QuestionPageDocument, baseOptions);
        }
export type QuestionPageQueryHookResult = ReturnType<typeof useQuestionPageQuery>;
export type QuestionPageLazyQueryHookResult = ReturnType<typeof useQuestionPageLazyQuery>;
export type QuestionPageQueryResult = Apollo.QueryResult<QuestionPageQuery, QuestionPageQueryVariables>;
...
export const QuestionsListDocument = gql`
    query QuestionsList($orderBy: [_QuestionOrdering], $first: Int, $offset: Int, $filter: _QuestionFilter, $tagsCount: Int = 5) {
 ...
 * });
 */
export function useTagPageQuery(baseOptions?: Apollo.QueryHookOptions<TagPageQuery, TagPageQueryVariables>) {
        return Apollo.useQuery<TagPageQuery, TagPageQueryVariables>(TagPageDocument, baseOptions);
      }
export function useTagPageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TagPageQuery, TagPageQueryVariables>) {
          return Apollo.useLazyQuery<TagPageQuery, TagPageQueryVariables>(TagPageDocument, baseOptions);
        }
...
export type TagPageQueryResult = Apollo.QueryResult<TagPageQuery, TagPageQueryVariables>;
...
export function useUserPageQuery(baseOptions: Apollo.QueryHookOptions<UserPageQuery, UserPageQueryVariables>) {
        return Apollo.useQuery<UserPageQuery, UserPageQueryVariables>(UserPageDocument, baseOptions);
      }
export function useUserPageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<UserPageQuery, UserPageQueryVariables>) {
          return Apollo.useLazyQuery<UserPageQuery, UserPageQueryVariables>(UserPageDocument, baseOptions);
        }
...
export const UsersListDocument = gql`
    query UsersList($orderBy: [_UserOrdering], $first: Int, $offset: Int, $filter: _UserFilter) {
