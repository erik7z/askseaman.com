...
export type AnswerFieldsFragment = (
  { __typename?: 'Answer' }
  & Pick<Answer, 'nodeId' | 'text' | 'upVotesCount' | 'downVotesCount' | 'canVote' | 'canVoteUp' | 'canVoteDown' | 'commentsCount'>
  & { author: (
    { __typename?: 'User' }
    & UserFieldsFragment
  ), createdAt?: Maybe<(
...
export type QuestionPageQuery = (
  ...
  & { Question?: Maybe<Array<Maybe<(
    { __typename?: 'Question' }
    & Pick<Question, 'nodeId' | 'title' | 'text' | 'viewsCount' | 'upVotesCount' | 'downVotesCount' | 'subscribersCount' | 'answersCount' | 'commentsCount'>
    & { author?: Maybe<(
      { __typename?: 'User' }
      & UserFieldsFragment
...
export type VoteMutation = (
  ...
  & { Vote: (
    { __typename: 'Question' }
    & Pick<Question, 'nodeId' | 'upVotesCount' | 'downVotesCount' | 'canVote' | 'canVoteUp' | 'canVoteDown'>
  ) | (
    { __typename: 'Answer' }
    & Pick<Answer, 'nodeId' | 'upVotesCount' | 'downVotesCount' | 'canVote' | 'canVoteUp' | 'canVoteDown'>
  ) }
);
