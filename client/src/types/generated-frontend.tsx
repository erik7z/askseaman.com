...
export type DeleteCommentMutation = (
  ...
  & { DeleteComment: (
    { __typename?: 'DeleteCommentResponse' }
    & Pick<DeleteCommentResponse, 'nodeId' | 'text'>
  ) }
);
...
export type QuestionListItemFieldsFragment = (
  { __typename?: 'Question' }
  & Pick<Question, 'nodeId' | 'title' | 'text' | 'viewsCount' | 'answersCount' | 'commentsCount' | 'canDelete' | 'canSubscribe' | 'isSubscribed' | 'subscribersCount'>
  & { author?: Maybe<(
    { __typename?: 'User' }
    & UserFieldsFragment
  )>, createdAt?: Maybe<(
...
export type AnswerFieldsFragment = (
  { __typename?: 'Answer' }
  & Pick<Answer, 'nodeId' | 'text' | 'canDelete' | 'canVote' | 'upVotesCount' | 'downVotesCount' | 'isVotedUp' | 'isVotedDown' | 'canComment' | 'commentsCount'>
  & { author: (
    { __typename?: 'User' }
    & UserFieldsFragment
  ), createdAt?: Maybe<(
...
export type DeleteAnswerMutation = (
  ...
  & { DeleteAnswer: (
    { __typename?: 'DeleteAnswerResponse' }
    & Pick<DeleteAnswerResponse, 'nodeId' | 'text'>
  ) }
);
...
export type DeleteQuestionMutation = (
  ...
  & { DeleteQuestion?: Maybe<(
    { __typename?: 'DeleteQuestionResponse' }
    & Pick<DeleteQuestionResponse, 'nodeId' | 'title'>
  )> }
);
...
export type QuestionPageQuery = (
  ...
  & { Question?: Maybe<Array<Maybe<(
    { __typename?: 'Question' }
    & Pick<Question, 'nodeId' | 'title' | 'text' | 'viewsCount' | 'answersCount' | 'canDelete' | 'canSubscribe' | 'isSubscribed' | 'subscribersCount' | 'canComment' | 'commentsCount'>
    & { author?: Maybe<(
      { __typename?: 'User' }
      & UserFieldsFragment
    )>, tags?: Maybe<Array<Maybe<(
...
export const QuestionAnswersListDocument = gql`
  ...
  Answer(filter: $filter, orderBy: timestamp_asc) {
    ...answerFields
  }
}
    ${AnswerFieldsFragmentDoc}`;
...
export const UserPageDocument = gql`
    query UserPage($nodeId: ID!, $tagsFirst: Int = 5, $questionsFirst: Int = 5, $questionsOffset: Int = 0, $answersFirst: Int = 5, $answersOffset: Int = 0) {
  User(nodeId: $nodeId) {
    ...userFields
    email
    location
